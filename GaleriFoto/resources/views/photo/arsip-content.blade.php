...
<div class="flex flex-col bg-white">
    <div class="transition-all ease-in-out min-h-[130px] sticky top-0 z-40 px-6 py-3 pt-6 bg-white border-b-[1.5px] border-gray-200">
        <div class="font-bold text-2xl">Arsip</div>
     ...
     @if($arsipFoto->count() > 0)
        <div class="text-gray-500 text-md font-normal font-inter bg-gray-100 p-6 backdrop-blur-lg">Menampilkan <span class="cardShowCounter"> {{ $arsipFoto->count() }}</span> Foto</div>
    @endif
