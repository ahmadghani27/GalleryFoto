        ...
        <div x-data="{ tab: 'single' }" class="self-stretch flex flex-col gap-6">
            ...
            <div class="self-stretch flex flex-col justify-start items-start gap-3">
                ...
                <div class="self-stretch p-5 rounded-2xl outline outline-1 outline-offset-[-1px] outline-black/5 flex justify-between items-center">
                    ...
                    <label class="w-48 h-14 px-2.5 py-5 rounded-2xl outline outline-[1.5px] outline-offset-[-1.5px] hover:text-white hover:bg-black outline-neutral-900 flex justify-center items-center gap-2.5 cursor-pointer transition-all duration-100 hover:bg-neutral-900">
