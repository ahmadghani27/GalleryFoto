    ...
    <div class="flex h-full w-full flex-col bg-white">
                ...
                <div class="flex w-full items-center justify-end gap-3">
                    ...
                    >
                        ...
                        >
                            ...
                            <div
                                x-text="selected"
                                class="text-neutral-900 font-inter text-base font-normal text-white group-hover:text-white"
                            ></div>
                        </div>
        ...
        @else
            ...
            >
                ...
                <div 
                    class="text-gray-500 text-md text-center font-normal w-full mt-3 font-interbg-transparent backdrop-blur-lg">
                    ...
                    >
                        ...
                        >
                            ...
                            <div
                                ...
                                class="h-1.5 self-stretch rounded-tl-[99px] rounded-tr-[99px]"
                            ></div>
                        </div>
                        <div
